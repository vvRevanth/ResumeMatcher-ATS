...
# Filter job titles (manual entry only)
selected_job_title = st.sidebar.text_input("Enter Job Title:")
...
# Ensure a job title and description are provided
if not selected_job_title or not jd:
  st.info("Please enter a job title and provide a job description.")
  st.stop()
